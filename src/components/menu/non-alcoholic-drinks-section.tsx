import { NON_ALCOHOLIC_DRINKS } from "@/lib/data/menu.data";

const NonAlcoholicDrinksSection = () => {
  return (
    <section className="grid md:grid-cols-2 gap-4">
      {NON_ALCOHOLIC_DRINKS.map((item, index) => (
        <div
...
export default NonAlcoholicDrinksSection;
