import { BOURBON_WHISKYS } from "@/lib/data/menu.data";

const BourbonWhiskySection = () => {
  return (
    <section className="grid md:grid-cols-2 gap-4">
      <h4 className="col-span-full text-lg md:text-xl font-extralight text-site-muted">
        01. Bourbon Whisky | 40ml / Bottle
      </h4>

      {BOURBON_WHISKYS.map((item, index) => (
        <div
...
export default BourbonWhiskySection;
